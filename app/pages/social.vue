<template>
  <div class="space-y-3">
    ...
    <!-- Incoming Requests -->
    <div v-if="pendingIncoming.length > 0" v-motion-fade class="bg-slate-900/40 backdrop-blur-sm sm:rounded-2xl rounded-none p-6 shadow-xl">
    ...
    <!-- Add Friend -->
    <div v-motion-fade class="bg-slate-900/40 backdrop-blur-sm sm:rounded-2xl rounded-none p-6 shadow-xl">
