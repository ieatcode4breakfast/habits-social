...
ALTER TABLE "bucket_habits" ALTER COLUMN "approval_status" SET DEFAULT 'accepted';--> statement-breakpoint
...
CREATE INDEX "password_reset_tokens_user_created_at_idx" ON "password_reset_tokens" USING btree ("user_id","created_at");