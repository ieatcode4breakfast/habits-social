...
process.env.NUXT_PUBLIC_API_BASE_URL = 'https://habits-social-staging.mycooltools.workers.dev';
process.env.NUXT_PUBLIC_PARTYKIT_HOST = 'habits-social-realtime-staging.ieatcode4breakfast.partykit.dev';
